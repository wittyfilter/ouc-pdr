...
public class DataHandling {
	...
	public static List<double[]> IntegrationForVelocity(List<double[]> accelerometer, double min, double max) throws MathException
	{
		...
		for(double i = min; i <= max; i = i + 0.02)
		{
			double velocity[] = {0, 0, 0, 0};
			velocity[0] = Util.Integration(functionaccX, i, i + 0.02);
			velocity[1] = Util.Integration(functionaccY, i, i + 0.02);
			velocity[2] = Util.Integration(functionaccZ, i, i + 0.02);
			velocity[3] = i + 0.02;
